...
var $___src_syntax_trees_ParseTreeType_js = (function() {
  ...
  var TYPED_BINDING_ELEMENT = 'TYPED_BINDING_ELEMENT';
...
var $___src_syntax_trees_ParseTrees_js = (function() {
  ...
  var TypedBindingElement = function($__super) {
    'use strict';
    var $__proto = $__getProtoParent($__super);
    var $TypedBindingElement = ($__createClass)({
      constructor: function(location, element, typeName) {
        this.location = location;
        this.element = element;
        this.typeName = typeName;
      },
      transform: function(transformer) {
        return transformer.transformTypedBindingElement(this);
      },
      visit: function(visitor) {
        visitor.visitTypedBindingElement(this);
      },
      get type() {
        return TYPED_BINDING_ELEMENT;
      }
    }, {}, $__proto, $__super, true);
    return $TypedBindingElement;
  }(ParseTree);
  ...
  var YieldExpressionTransformer = function($__super) {
    ...
    var $YieldExpressionTransformer = ($__createClass)({
      ...
      transformYieldForExpression_: function(tree) {
        ...
        return parseStatement($__3, g, id(TRACEUR_RUNTIME), tree.expression, next, isGeneratorObject, g, id(YIELD_SENT), id(YIELD_ACTION), ACTION_SEND, id(YIELD_ACTION), ACTION_SEND, next, isGeneratorObject, g, id(YIELD_SENT), g, next, g, id(YIELD_SENT), next, id(YIELD_SENT), next, createYieldStatement(createMemberExpression(next, 'value')));
      }
    }, {transformTree: function(identifierGenerator, tree) {
  ...
  var ParseTreeValidator = function($__super) {
    ...
    var $ParseTreeValidator = ($__createClass)({
      ...
      visitTypedBindingElement: function(tree) {
        ...
        this.checkVisit_(element.type == BINDING_ELEMENT, 'binding element expected');
      },
      visitTypeName: function(tree) {},
      visitUnaryExpression: function(tree) {
        this.checkVisit_(tree.operand.isArrowFunctionExpression(), tree.operand, 'assignment expression expected');
  ...
  var syntax = (function() {
    ...
    var trees = (function() {
      ...
      return Object.preventExtensions(Object.create(null, {
        ...
        TypedBindingElement: {
          get: function() {
            return $___src_syntax_trees_ParseTrees_js.TypedBindingElement;
          },
          enumerable: true
        },
        UnaryExpression: {
